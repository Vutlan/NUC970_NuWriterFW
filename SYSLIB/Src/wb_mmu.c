...
ALIGN_ATTR(0x4000) unsigned int _mmuSectionTable[4096];
ALIGN_ATTR(1024) static _CTable _mmuCoarsePageTable[_CoarsePageSize]; 			// maximum 64MB for coarse pages
ALIGN_ATTR(1024) static _CTable _mmuCoarsePageTable_NonCache[_CoarsePageSize];	// Shadow SDRAM area for non-cacheable
